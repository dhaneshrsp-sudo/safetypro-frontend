...
// Update ac-layout-fix to use dashboard scroll pattern
...
/* SCROLL FIX: use same pattern as dashboard — .content scrolls */
.content{overflow-y:auto!important;overflow-x:hidden!important;}
/* Tab panels — no internal scroll, let content scroll */
.tab-panel{min-height:0!important;overflow:visible!important;}
.tab-panel.active{overflow:visible!important;}
#ac-ims{overflow:visible!important;min-height:0!important;}
/* Sub-panels also visible so content flows */
.ac-sub-panel{overflow:visible!important;min-height:0!important;}
.ac-sub-panel.active{overflow:visible!important;}
/* Other tab panels */
#ac-investigation,#ac-legal,#ac-meeting{overflow:visible!important;}
</style>`;
  content = content.slice(0, layoutFix) + newCSS + content.slice(layoutEnd);
  console.log('✅ Updated to dashboard scroll pattern');
}
