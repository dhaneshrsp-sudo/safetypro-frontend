...
const RULE = ".content{border-right:1px solid rgb(51, 65, 85)!important;}\n";
let done = 0;
for (const file of files) {
  let html = fs.readFileSync(file, "utf8");
  if (html.includes(".content{border-right:1px solid rgb(51, 65, 85)")) continue;
  const before = html;
...
console.log("Added content right-border on " + done + " files");
